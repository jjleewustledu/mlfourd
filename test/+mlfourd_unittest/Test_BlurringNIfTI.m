classdef Test_BlurringNIfTI < mlfourd_unittest.Test_mlfourd
	%% Test_BlurringNIfTI  

	%  Usage:  >> results = run(mlfourd_unittest.Test_BlurringNIfTI)
 	%          >> result  = run(mlfourd_unittest.Test_BlurringNIfTI, 'test_dt')
