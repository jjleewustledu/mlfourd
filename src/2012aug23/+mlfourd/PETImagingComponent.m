classdef PETImagingComponent < mlfourd.ImagingComponent
	...
	%  Version $Revision: 1231 $ was created $Date: 2012-08-23 16:21:49 -0500 (Thu, 23 Aug 2012) $ by $Author: jjlee $,  
 	%  last modified $LastChangedDate: 2012-08-23 16:21:49 -0500 (Thu, 23 Aug 2012) $ and checked into svn repository $URL: file:///Users/Shared/Library/SVNRepository/mpackages/mlfourd/src/+mlfourd/trunk/PETImagingComponent.m $ 
 	%  Developed on Matlab 7.13.0.564 (R2011b) 
 	%  $Id: PETImagingComponent.m 1231 2012-08-23 21:21:49Z jjlee $ 
	...
	methods 		
        ...
        function t    = get.tries(this)
            t = this.converter.tries;
        end 
    ...
    methods (Access = 'protected')
        ...
        function fn   = hdrinfo_filename(this, tracer, pnum)
            ...
            if (lstrfind(tracer, 'g3') || lstrfind(tracer, 'rot'))
                fn = [pnum tracer '.hdr.info'];
            else
                fn = [pnum tracer '_g3.hdr.info'];
            end
                fn = fullfile(this.hdrPath, fn);
        end 
