classdef (Sealed) Np797Registry < mlfourd.FslRegistry
    ...
    methods
        ...
        function fn  = epi_filename(this, isfq)
            ...
            switch (double(isfq))
                case 1
                    fn = fullfile(this.epi_path, [fn this.onRefSuffix this.FILETYPE_EXT]);
                case 0
                    fn =                         [fn this.onRefSuffix this.FILETYPE_EXT];
                otherwise
            end
        end % epi_filename
