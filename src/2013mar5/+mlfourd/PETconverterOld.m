    ...
    methods
        ...
        function set.honii(obj, nii)
            ...
            if (mlfourd.NIfTI.isNIfTI(nii))
                nii.img   = mlfourd.NIfTI.ensureDble(nii.img);
                obj.honii = nii;
            else
        ...
        function oef = make_oef(obj)
            ...
            if (mlfourd.NIfTI.isNIfTI(obj.oefnii))
                ...
                msk        = mlfourd.NIfTI.ensureDble(obj.fuzzyFg) .* mlfourd.NIfTI.ensureDble(oef > 0) .* mlfourd.NIfTI.ensureDble(oef < 1);
                oef        = squeeze(oef .* msk);
        ...
        function cbf = counts2cbf(obj, cnts)
            ...
            if (mlfsl.O15Builder.BUTANOL_CORRECTION) 
