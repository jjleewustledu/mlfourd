classdef NIfTI < mlfourd.AbstractImage
    ...
    properties (Constant)
        NIFTI_SUBCLASS  = {'mlfourd.NIfTI' 'mlfourd.NiiBrowser' 'mlfourd.NIfTI_mask'} % DEPRECATED
    ...
    methods (Static)
        ...
        function nii  = load(fn, desc)
            ...
            if (~isempty(fext))
                ...
                elseif (strcmp(fext, '.nii') || strcmp(fext, '.hdr'))
                ...
                try
                    nii = NIfTI.load_nii_gz([fn mlfourd.AbstractImage.FILETYPE_EXT], desc); 
                catch ME 
                    try
                        ...
                        try
                            ...
                            handexcept(ME2, 'mlfourd:IOError', 'NIfTI.load could not file %s', fn);
                        end
                    end
                end
            end
    ...
    methods
        ...
        function this = set.fileprefix(this, fp)
            assert(ischar(fp));
            [~,this.fileprefix,~] = filepartsx(fp, mlfourd.AbstractImage.FILETYPE_EXT);
        end 
        ...
        function this = set.img(this, image)
            ...
            image                            = this.ensureNumeric(image);
        ...
        function this = saveas(this, fname)
            ...
            [this.filepath,this.fileprefix,~] = filepartsx(fname, mlfourd.AbstractImage.FILETYPE_EXT);
            this.save;
        end % saveas  
