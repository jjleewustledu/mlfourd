classdef BlurringTool_20211201 < handle & mlfourd.ImagingFormatTool_20211201
    ...
    methods (Static) 
        function img   = gaussFullwidth(img, varargin)
            ...
            %  See also mlfourd.BlurringTool_20211201.gaussSigma
            ...
            img = BlurringTool_20211201.gaussSigma( ...
                ip.Results.img, ...
                BlurringTool_20211201.width2sigma(ip.Results.width, ip.Results.height), ...
        ...
        function img   = gaussSigma(varargin)
            ...
            %  See also mlfourd.BlurringTool_20211201.gaussFullwidth, imgaussfilt, imgaussfilt3
            ...
            metppix = BlurringTool_20211201.checkedMetppix(metppix, sigma);
            ...
            switch(ndims_)
                ...
                otherwise
                    error('mlfourd:parameterOutOfBounds', ...
                         ['BlurringTool_20211201.gaussSigma.ndims_->' num2str(ndims_) ', but only ndims_ \in [2 3] are supported']);
            end
        end       
        function width = sigma2width(sigma, fheight)
            ...
            switch (nargin)
                ...
                case 2 
                otherwise
                    error('mlfourd:InputParamsErr', help('BlurringTool_20211201.sigma2width'));
            end
        ...
        function sigma = width2sigma(width, fheight)
            ...
            switch (nargin)
                ...
                case 2
                otherwise
                    error('mlfourd:InputParamsErr', help('BlurringTool_20211201.width2sigma'));
            end
    ...
    methods 
        ...
        function blurred(this, varargin)
            ...
            this.addLog(sprintf('BlurringTool_20211201:  blur->%s', mat2str(this.blur)));
        ...
        function s = sizeEuclid(this)
 		...
 		function this = BlurringTool_20211201(h, varargin)
    ...
    methods (Static, Access = protected)
        ...
        function metppix = checkedMetppix(metppix, sigma)
            if (length(metppix) < length(sigma))
                metppix = mlfourd.BlurringTool_20211201.stretchVec(metppix, length(sigma));
            end
            if (length(metppix) > length(sigma))
        ...
        function sz      = embedVecInSitu(sz, fixedsz)
            ...
            %  e.g.  >> sz = BlurringTool_20211201.embedVecInSitu([2 2 30], [18 18 31 100])
            %        sz = 
            %            2 2 30 100
            %        >> sz = BlurringTool_20211201.embedVecInSitu([18 18 31 100], [2 2 30])
            %        sz = 
            %            18 18 31
            ...
            switch (nargin)
                ...
                otherwise
                    error('mlfourd:InputParamsErr:InputParamsErr', ...
                         ['BlurringTool_20211201.stretchVec.nargin->' num2str(nargin)]);
            end
    ...
    methods (Access = protected)
        ...
        function morphologic(this, fhandle, varargin)
            ...
            this.addLog(sprintf('BlurringTool_20211201:  %s', func2str(fhandle)));
        end
    end
