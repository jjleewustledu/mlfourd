classdef InnerNIfTIdIO < mlfourd.NIfTIIO
	%% InnerNIfTIdIO
    ...
    methods %% Set/Get
        ...
        function this = set.filepath(this, pth)
            ...
            this.addLog('InnerNIfTIdIO.set.filepath<-%s', pth);
        end
        ...
        function this = set.fileprefix(this, fp)
            ...
            this.addLog('InnerNIfTIdIO.set.fileprefix<-%s', fp);
        end
        ...
        function this = set.filesuffix(this, fs)
            ...
            this.addLog('InnerNIfTIdIO.set.filesuffix<-%s', fs);
        end
