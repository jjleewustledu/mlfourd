classdef NIfTIdecorator6 < mlfourd.INIfTI
	%% NIFTIDECORATOR6 maintains an internal component object by composition, 
    ...
    methods
 		function this = NIfTIdecorator6(varargin) 
            %% NIFTIDECORATOR6 decorates other INIfTI objects, keeping the passed object as an internal component by composition;
