classdef PETConverter_2013apr22 < mlfourd.AbstractConverter
    ...
    methods (Static)
        ...
        function mpth = findModalityPath(pth, varargin)
            mpth = findModalityPath@mlfourd.AbstractConverter( ...
                @mlfourd.PETConverter.findModalityPath, ...
                mlfourd.PETConverter.modalityFolders, ...
                pth, varargin{:});
        end  
    end % static methods
    ...
    methods (Access = 'protected')
        function this = PETConverter_2013apr22(petpth)
            %% PETCONVERTER
