classdef (Sealed) FilesystemTool_20211201 < handle & matlab.mixin.Heterogeneous & matlab.mixin.Copyable & mlfourd.AbstractImagingTool_20211201
	%% FILESYSTEMTOOL  
	...
	methods 
        ...
        function sz  = size(this, varargin)
            if (lstrfind(this.filesuffix, mlfourd.FourdfpInfo.SUPPORTED_EXT))
        ...
        function this = FilesystemTool_20211201(h, fqfn, varargin)
