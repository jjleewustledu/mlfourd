classdef DynamicsTool_20211201 < handle & mlfourd.ImagingFormatTool_20211201
	%% DYNAMICSTOOL
	...
	methods 
        ...
        function this = diff(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.diff');
        end
        function this = gradient(this, varargin)
            ...
            if (4 == this.ndims)
                ...
                this.addLog('DynamicsTool_20211201.gradient');
                return
            end
            if (3 == this.ndims)
                img = this.imagingFormat_.img;
            ...
            error('mlfourd:RuntimeError', 'DynamicsTool_20211201.gradient.ndims->%i', this.ndims)
        end
        ...
        function this = mean(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.mean');
        end
        function this = median(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.median');
        end
        function this = mode(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.mode');
        end   
        ...
        function this = Q(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.Q')
        end
        function this = std(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.std');
        end
        function [this,T] = timeAveraged(this, varargin)
            ...
            if ~isempty(ipr.weights)
                try                
                    ...
                    handexcept(ME, ...
                        ...
                        'DynamicsTool_20211201.timeAveraged:  supplied weights may be inconsistent:  %s', num2str(ipr.weights))
                end 
            end
            ...
            function namesAndLogging()
                ...
                this.addLog('DynamicsTool_20211201.timeAveraged weighted by %s', mat2str(ipr.taus/sum(ipr.taus)));
            end
        end
        function [this,T] = timeContracted(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.timeContracted over %s', mat2str(T));
        end  
        function [times,this] = timeShifted(this, times, Dt)
            ...
            this.addLog('DynamicsTool_20211201.timeShifted by %g', Dt);
        end  
        function this = var(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.var');
        end        
        function [this,M] = volumeAveraged(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.volumeAveraged');
        end
        function [this,M] = volumeContracted(this, varargin)
            ...
            this.addLog('DynamicsTool_20211201.volumeContracted over %s', M.fileprefix);            
        end
        
 		function this = DynamicsTool_20211201(h, varargin)
