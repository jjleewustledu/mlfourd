classdef NIfTIdecorator2 < mlfourd.INIfTI & mlio.IOInterface
    ...
    %  KLUDGE:  Matlab checks that dependent properties do not access stored values.  Multiple composed NIfTIdecorator2 
    ...
    %      In class 'mlfourd.NIfTIdecorator2', the get method for Dependent property 'filename' attempts to 
    %      access the stored property value.  Dependent properties don't store a value and can't be accessed
    %      from their get method.
    %     
    %      Error in mlfourd.NIfTIdecorator2/get.filename (line 66)
    ...
    methods (Static)
        ...
        function this = load(varargin)
            ...
            %  Usage:  obj = NIfTIdecorator2.load(filename[, description]);
            
            import mlfourd.*;
            this = NIfTIdecorator2(NIfTId.load(varargin{:}));
        end
    end
