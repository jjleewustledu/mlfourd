classdef NIfTIdecorator3 < mlfourd.INIfTI
	%% NIFTIDECORATOR3 maintains an internal component object by composition, 
    ...
    methods
 		function this = NIfTIdecorator3(varargin) 
            %% NIFTIDECORATOR3 decorates other INIfTI objects, keeping the passed object as an internal component by composition;
