classdef NumericalTool_20211201 < handle & mlfourd.ImagingFormatTool_20211201 & mlpatterns.HandleNumerical & mlpatterns.HandleDipNumerical
...
%            this.imagingFormat_.fileprefix = sprintf('%s_flip%i', this.imagingFormat_.fileprefix, b);
        ...
        function sum(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  sum %s %s', this.fileprefix, mat2str(varargin{:}))); 
        end
        function tan(this)
            this.usxfun(@tan);
        end
        ...
        function false(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  false %s', this.fileprefix)); 
        end
        function find(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  find %s', this.fileprefix)); 
        end
        function nan(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  nan %s', this.fileprefix)); 
        end
        function ones(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  ones %s', this.fileprefix)); 
        end
        function reshape(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  reshape %s', mat2str(size(this.imagingFormat_.img)))); 
        end
        function scrubNanInf(this)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  scrubNanInf %s', this.fileprefix)); 
        end
        function true(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  true %s', this.fileprefix)); 
        end
        function zeros(this, varargin)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  zeros %s', this.fileprefix)); 
        end
        ...
        function lusxfun(this, funh)
            ...
            this.imagingFormat_.addLog( ...
                sprintf('NumericalTool_20211201:  %s %s', func2str(funh), this.fileprefix));
        end
        function lbsxfun(this, funh, b)
            ...
            if (isnumeric(b))
                ...
                this.imagingFormat_.addLog( ...
                    sprintf('NumericalTool_20211201:  l%s %s %s', func2str(funh), this.fileprefix, this.bstr(b)));
                return
            end
            if (isa(b, 'mlfourd.ImagingContext2'))
                b = b.nifti;
                ...
                this.imagingFormat_.fileprefix = [this.imagingFormat_.fileprefix '_l' char(funh) '_' this.bstr(b)];
                this.imagingFormat_.addLog( ...
                    sprintf('NumericalTool_20211201:  l%s %s %s', func2str(funh), this.fileprefix, b.fileprefix));
                return
            end
        ...
        function bsxfun(this, funh, b)
            ...
            if (isnumeric(b))
                ...
                this.imagingFormat_.addLog( ...
                    sprintf('NumericalTool_20211201:  %s %s %s', func2str(funh), this.fileprefix, this.bstr(b)));
                return
            end
            if (isa(b, 'mlfourd.ImagingContext2'))
                b = b.nifti;
                ...
                this.imagingFormat_.fileprefix = [this.imagingFormat_.fileprefix '_' char(funh) '_' this.bstr(b)];
                this.imagingFormat_.addLog( ...
                    sprintf('NumericalTool_20211201:  %s %s %s', func2str(funh), this.fileprefix, b.fileprefix));
                return
            end
            b = ImagingFormatContext(b);
            this.imagingFormat_ = ImagingFormatContext( ...
        ...
        function this = NumericalTool_20211201(h, varargin)
            this = this@mlfourd.ImagingFormatTool_20211201(h, varargin{:});
        end
    end 
