classdef EEGTool < handle & mlfourd.ImagingState2
    %% line1
    %  line2
    %  
    %  Created 10-Dec-2021 23:03:27 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlfourd/src/+mlfourd.
    ...
    methods
        ...
        function ifc = edt(this)
            error('mlfourd:NotImplementedError', 'ImagingTool.edf()')
        end

        %%

        function this = EEGTool(varargin)
            %  Args:
