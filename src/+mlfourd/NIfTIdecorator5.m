classdef NIfTIdecorator5 < mlfourd.INIfTI
	%% NIFTIDECORATOR5 maintains an internal component object by composition, 
    ...
    methods
 		function this = NIfTIdecorator5(varargin) 
            %% NIFTIDECORATOR5 decorates other INIfTI objects, keeping the passed object as an internal component by composition;
