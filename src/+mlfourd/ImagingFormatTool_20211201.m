classdef ImagingFormatTool_20211201 < handle & matlab.mixin.Heterogeneous & matlab.mixin.Copyable & mlfourd.AbstractImagingTool_20211201
	...
	methods		
            ...
            switch this.filesuffix
                ...
                otherwise
                    error('mlfourd:ValueError', ...
                        'ImagingFormatTool_20211201.imagingFormat.this.filesuffix ~ %s', this.filesuffix)
            end
        end
        ...
        %% delegate to ImagingFormatTool_20211201
        ...
        function        export(this, varargin)
            this.addLog('mlfourd.ImagingFormatTool_20211201.export %s', this.fqfilename)
        ...
        function        save(this)
            this.addLog('mlfourd.ImagingFormatTool_20211201.save %s', this.fqfilename)
        ...
        function this = ImagingFormatTool_20211201(h, varargin)
            this = this@mlfourd.AbstractImagingTool_20211201(h);            
