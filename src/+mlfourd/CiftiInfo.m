classdef CiftiInfo < handle & matlab.mixin.Heterogeneous & matlab.mixin.Copyable & mlio.IOInterface
	%% IMAGINGINFO manages metadata and header information for imaging.  Internally, it uses CIfTI conventions.
    %  
    %  Created 05-Oct-2022 00:23:05 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlfourd/src/+mlfourd.
    ...
    methods
        ...
        function this = CiftiInfo(varargin)
            %% CIFTIINFO 
            %  Args:
    ...
    methods (Static)
        function this = createFromFilename(fn, varargin)
            ...
            this = CiftiInfo(hf, varargin{:});
        end
        function this = createFromFilesystem(fs, varargin)
            import mlfourd.*
            this = CiftiInfo(fs, varargin{:});
        end
        function e = defaultFilesuffix()
            e = '.nii';
        end
        function f = tempFqfilename
            f = tempFqfilename(['mlfourd_CiftiInfo' mlfourd.CiftiInfo.defaultFilesuffix]);
        end
    end
