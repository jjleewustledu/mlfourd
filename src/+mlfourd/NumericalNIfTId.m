classdef NumericalNIfTId < mlfourd.NIfTIdecoratorProperties & mlpatterns.Numerical & mlpatterns.DipNumerical
    ...
    methods
        function this = usxfun(this, funh)
            ...
            this.addLog( ...
                sprintf('NumericalNIfTId:  %s %s', func2str(funh), this.fileprefix));
        end
        function this = bsxfun(this, funh, b)
            ...
            if (isa(b, 'mlfourd.INIfTI'))
                ...
                this.addLog( ...
                    sprintf('NumericalNIfTId:  %s %s %s', func2str(funh), this.fileprefix, b.fileprefix));
            else
                this = this.makeSimilar('img', double(bsxfun(funh, this.component.img, b)), ...
                                        'descrip', sprintf('NumericalNIfTId.bsxfun %s %s %s', ...
                                                           func2str(funh), this.fileprefix, mat2str(b)));
                this.addLog( ...
                    sprintf('NumericalNIfTId:  %s %s %s', func2str(funh), this.fileprefix, mat2str(b)));
            end
        end
