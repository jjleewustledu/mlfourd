...
#short_version = mlfourd.__version__.split("+")[0]
release = "0.1.0"
version = "0.1.0"
...
def generate_apidocs(*args):
    ...
    module_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "mlfourd"))
...
html_theme_options = {
    ...
    "icon_links": [
        {"name": "GitHub", "url": "https://github.com/jjleewustledu/mlfourd", "icon": "fab fa-github-square"},
...
html_logo = "../images/mlfourd-logo-color.png"
